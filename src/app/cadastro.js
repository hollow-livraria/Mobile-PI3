...
import { View, TextInput, Button, Text, TouchableOpacity, ActivityIndicator, Alert, StyleSheet, ScrollView } from 'react-native';
...
export default function Cadastro() {
  ...
  // Máscara para data de nascimento: só números, máximo 8 dígitos (DDMMAAAA)
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput placeholder="Digite seu nome completo..." value={formData.nome} onChangeText={v => handleChange('nome', v)} style={styles.input} />
      </View>

      <View style={styles.inputContainer}>
        <Text style={styles.label}>E-mail</Text>
        <TextInput placeholder="exemplo@gmail.com" value={formData.email} onChangeText={v => handleChange('email', v)} keyboardType="email-address" style={styles.input} />
      </View>

      <View style={styles.inputContainer}>
        <Text style={styles.label}>CPF</Text>
        <TextInput placeholder="Digite seu CPF..." value={formData.cpf} onChangeText={v => handleChange('cpf', v)} keyboardType="numeric" maxLength={14} style={styles.input} />
      </View>
      ...
      <View style={styles.inputContainer}>
        ...
        <TextInput placeholder="Digite seu número de telefone..." value={formData.telefone} onChangeText={v => handleChange('telefone', v)} keyboardType="phone-pad" maxLength={15} style={styles.input} />
      </View>

      <View style={styles.inputContainer}>
        <Text style={styles.label}>Senha</Text>
        <TextInput placeholder="Digite sua senha..." value={formData.password} onChangeText={v => handleChange('password', v)} secureTextEntry style={styles.input} />
      </View>

      <View style={styles.inputContainer}>
        <Text style={styles.label}>Confirme sua Senha</Text>
        <TextInput placeholder="Digite sua senha novamente..." value={formData.confirmPassword} onChangeText={v => handleChange('confirmPassword', v)} secureTextEntry style={styles.input} />
      </View>

      {/* Checkbox bonito para termos de uso */}
      <TouchableOpacity
      ...
      >
        <View style={styles.checkboxRow}>
          <View style={[styles.checkboxBox, formData.terms && styles.checkboxBoxChecked]}>
